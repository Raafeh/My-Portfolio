  ...
  <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
    ...
    <div className="container mx-auto h-full flex flex-col items-center xl:flex-row 
      ...
      <div className="flex-1 flex flex-col justify-center">
        ...
        exit='hidden' 
        className="h2">
          Captivating <span className="text-accent">stories</span> birth significant designs.
        </motion.h2>
        <motion.p
        ...
        className="max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-12 px-2 xl:px-0">
          I am a passionate designer and developer with a keen interest in
          creating beautiful and functional user experiences. I have a
          background in Graphic Design and Web Development.
        </motion.p>
        {/* counters */}
        <motion.div
